<div class=bodypanel>
	<span class=lbl1>End of Quarter Grades</span><br /><br />
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<span class=lbl1>Quarter End Date: </span><span style="color: white; font-size: small;">{qeDate}</span>
	<hr />
	<div style='float: right;'>
		<span class=lnk1>
			[ <a href='apis/gradesdump.php?type=end&phssy={phssy}&sem={semester}&qtr={quarter}' target='_blank'>download</a> ]
		</span>
	</div>	
	End of Quarter Scores<br />
