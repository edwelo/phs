...
<div class=mainpanel>
	...
	<ul id="topmenu">
		<li><a href="?t={unit_abbrv}&t1={tmenu1}" target="_self">{tmenu1}</a></li>
		<li><a href="?t={unit_abbrv}&t1={tmenu2}" target="_self">{tmenu2}</a></li>
		<li><a href="?t={unit_abbrv}&t1={tmenu3}" target="_self">{tmenu3}</a></li>
		<li><a href="?t={u12nit_abbrv}&t1={tmenu4}" target="_self">{tmenu4}</a></li>
		<li><a href="?t={unit_abbrv}&t1={tmenu5}" target="_self">{tmenu5}</a></li>
	</ul>
