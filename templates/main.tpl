...
<head>
	...
	<script type='text/javascript' src='commons/{jsScript}'></script>
	<style type="text/css">
		<!-- insert css -->
...
<div style="margin: auto; padding: 4px; min-width: 800px; background: #eef; border-radius: 10px 10px 0 0;">
	...
	<div style="float: right; text-align: right;">
		<span class=lnk1><a href="../">Home</a></span> | <span class=lnk1><a href="../resources/fbcs.html" target="_blank">Resources</a></span> | <span class=lnk1><a href="javascript:document.logaction.submit()">{log_action}</a></span>
	...
	<div style='background: #333; float: left; margin: 0; padding: 0 0 0 0 90px; width: 100%; text-align: center; color: #eef;'>
		<button><a style="text-decoration: none; color: black;" href='?{back_menu_link}'>&nbsp;&nbsp;&nbsp;&nbsp; Back &nbsp;&nbsp;&nbsp;&nbsp;</a></button>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		{location}
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button><a style="text-decoration: none; color: black;" href='?{main_menu_link}'>Main Menu</a></button>
	</div>
